...
.DESCRIPTION
  Locates HealthCheck folder, loads Utils.ps1, runs Check-* scripts,
  records PASS/FAIL results, saves JSON report.
#>
...
if (Test-Path $candidate) {
    ...
    $matches = Get-ChildItem -Path $RepoRoot -Directory -Recurse -ErrorAction SilentlyContinue |
        Where-Object { $_.Name -eq $HealthCheckFolderName }
